		...
		<!-- Wrapper -->
			...
			<div id="main3">
				<!-------------------------------------------------------------------------------------------- 
						...
						<h2 style="align:center;">모든 게시판 검색 결과 (총: 개의 게시글 발견)</h2>
							<section class="sresult">
								<article>
								<h2><a href="SearchResult.jsp">검색된 게시판 명</a></h2>
									<header>
										<h3><a href="#">검색 결과명</a></h3>
									</header>
									<a href="#" class="image fit">검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.
									검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.
									검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.</a>
								...
								<article>
									<header>
										<h3><a href="#">검색 결과명</a></h3><span class="date">작성 일자 :April 18, 2017</span>
									</header>
									<a href="#" class="image fit">검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.
									검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.
									검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.검색결과 내용입니다.</a>
