...
<html>
	<head>
		...
		<link rel="stylesheet" href="PlzWindowShop/assets/css/index.css" />
	</head>
	...
	<body class="is-preload" onload="javascript:a(); javascript:All_copy();">
			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Nav -->
					<nav id="nav">
						...
						<ul class="icons">
							<li><a href="signup.jsp" class="reg"><span class="label"></span></a></li>
							<li><a href="loginForm.jsp" class="login"><span class="label"></span></a></li>
					...
					<div id="main">
						...
						<!-- Featured Post -->
							<article class="post featured">
								<header class="major">
									<span class="date">2019-08-08 ~ 2019-08-20</span>
									<h2><a href="#">할인<br />
									Event</a></h2>
									<p></p>
								</header>
								...
								<ul class="actions special">
									<li><a href="javascript:c();" class="button large">이벤트 게시판</a></li>
								</ul>
							</article>
